        ...
        <div className="qualification__sections">
          ...
          >
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              <div>
                <h3 className="qualification__title">Masters of Computer Application🎓</h3>
                <span className="qualification__subtitle">Chandigarh University - Chandigarh</span>
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              ...
              <div>
                ...
                <span className="qualification__subtitle">TilkaManjhi University - Bhagalpur</span>
                <div className="qualification__calender">
