            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">gaurav80raj@gmail.com</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">(+91) 9523534015</span>

                        <a href="https://api.whatsapp.com/send?phone=9523534015&text=Hello, I would like to connect with you!" className="contact__button">Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>
            </div>
